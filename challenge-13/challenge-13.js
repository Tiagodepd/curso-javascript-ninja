(function () {
  ...
  var estadoMenosSeteLetras = brasil.every(function (item) {
    return item.length > 7;
  });
  console.log(
    estadoMenosSeteLetras
      ? "Sim, todos os estados tem mais de 7 letras!"
      : "Nem todos os estados tem mais de 7 letras!"
  );
  ...
  var Ceará = brasil.some(function (item) {
    return item === "Ceará";
  });
  console.log(Ceará ? "Ceará está incluído!" : "Ceará não foi incluído :(");
