...
que foram passados para a primeira função `calculator`.
*/
  ...
  // A função callback foi criada, mas, para o JS, ela ainda não existe. Só passará a existir quando a função global (calculator) for invocada por meio de uma variável.

  /* 
Declare uma variável chamada `sum`, e atribua a ela a função `calculator`,
passando dois números por parâmetro.
*/
  var sum = calculator(3, 6); // Função calculator sendo atribuída a variável 'sum'
  // A função callback ainda não existe aqui.
...
*/
  ...
  // A função callback passa a existir aqui, pois a função global(calculator) foi invocada por meio da variável 'sum'.
...
*/
  var subtraction = calculator(3, 1);
  var multiplication = calculator(9, 6);
  var division = calculator(12, 4);
