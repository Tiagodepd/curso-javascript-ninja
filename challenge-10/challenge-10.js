(function () {
  ...
  function isOperatorValid(operator) {
    ...
    /* Aqui está retornando o objeto 'operation', criado mais acima, 
    verificando a validade de suas propriedades por meio do 
    parâmetro 'operator', ou seja, se a propriedade for válida, 
    retorna a function com o return do objeto operation, em caso
    de invalidade, retorna 'undefined'. Por isso, para ser válido, 
    a lógica deteriminada foi que o retorno do objeto junto com o input
    do operator passado seja diferente de 'undefined'. */

    //Outra forma mais eficiente de fazer (usando o operador booleano):
    return !!operation[operator];
    //Aqui usa-se a lógica do booleano de function (truthy) e de undefined (falsy)
  ...
  /*
    ...
    operador da function calculator, quando a operação não for válida.
