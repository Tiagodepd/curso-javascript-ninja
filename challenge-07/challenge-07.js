...
*/
var myArray = ["Tiago", 3, { a: 6, b: 9 }, function () {}, true];
...
*/
console.log(addItem(["one", 2, false]));
...
for (var num = 100; num <= 120; num++) {
  num % 2 === 0 ? console.log(num) : ""; // O ternário 'if' sempre precisa do 'else'. Já a estrutura não ternária do 'if', não necessariamente precisa do 'else'.
}
