(function () {
  ...
  /*
    ...
    */
  console.log("\nOperation:");
  var operation = justMod2Or3.reduce(function (acumulator, atual) {
    return (acumulator + 1) * atual;
  }, 0);
  ...
  /*
    ...
    */
  console.log("\nOperation 2:");
  var operation2 = justMod2Or3.reduceRight(function (acumulator, atual) {
    return (acumulator + 1) * atual;
  }, 0);
  ...
  var name = ["Ti", "a", "go"];
  var recuceP = name.reduce(function (acumulator, atual) {
    return acumulator + "P" + atual;
  }, "");
  console.log(recuceP);
  ...
  /*
    ...
    */
  console.log("\nInversed Name:");
  var inversedName = name.reduceRight(function (acumulator, atual) {
